...
class _SentImage {
  ...
  // True for images that went through the editor (Create Text / Create
  // Image), which bake content into the panel's pre-rotated portrait frame,
  // so the preview needs to rotate them back for correct on-screen viewing.
  // False for raw photos added via the simple "Pick Image" flow, which
  // should just display exactly as picked, with no rotation applied.
